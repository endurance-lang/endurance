...
#line 538 "translate.y"
                                                       { 
                                                        ...
                                                        fprintf(dot, "{rank=same; n%d n%d n%d n%d n%d;}\n", struct_, identifier, block_open, (yyvsp[-1].data).node_id, block_close);
                                                        
                                                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, struct_);
...
#line 559 "translate.y"
                                                    { 
                                                        ...
                                                        fprintf(dot, "{ rank=same; n%d n%d n%d n%d n%d; }\n", enum_, identifier, block_open, (yyvsp[-1].data).node_id, block_close);
                                                            
                                                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, enum_);
                                                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, identifier);
                                                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, block_open);
                                                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[-1].data).node_id);
                                                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, block_close);
...
#line 631 "translate.y"
                    { 
                        ...
                        fprintf(dot, "{rank=same; n%d n%d n%d;}\n", (yyvsp[-2].data).node_id, add, (yyvsp[0].data).node_id);
...
#line 646 "translate.y"
                    { 
                        ...
                        fprintf(dot, "{rank=same; n%d n%d n%d;}\n", (yyvsp[-2].data).node_id, sub, (yyvsp[0].data).node_id);
                        
                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[-2].data).node_id);
                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, sub);
                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[0].data).node_id);
...
#line 662 "translate.y"
                    { 
                        ...
                        fprintf(dot, "{rank=same; n%d n%d n%d;}\n", (yyvsp[-2].data).node_id, mul, (yyvsp[0].data).node_id);

                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[-2].data).node_id);
                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, mul);
                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[0].data).node_id);
...
#line 678 "translate.y"
                    { 
                        ...
                        fprintf(dot, "{rank=same; n%d n%d n%d;}\n", (yyvsp[-2].data).node_id, div, (yyvsp[0].data).node_id);

                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[-2].data).node_id);
                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, div);
                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[0].data).node_id);
...
#line 694 "translate.y"
                    { /* geraTemp1, geraTemp2, chama codeGen(t1, op, t2) */ 
                        ...
                        fprintf(dot, "{rank=same; n%d n%d n%d;}\n", (yyvsp[-2].data).node_id, mod, (yyvsp[0].data).node_id);
...
#line 707 "translate.y"
                                { 
                                    ...
                                    fprintf(dot, "{rank=same; n%d n%d n%d;}\n", (yyvsp[-2].data).node_id, and_, (yyvsp[0].data).node_id);
...
#line 723 "translate.y"
                                { 
                                    ...
                                    fprintf(dot, "{rank=same; n%d n%d n%d;}\n", (yyvsp[-2].data).node_id, or_, (yyvsp[0].data).node_id);

                                    fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[-2].data).node_id);
                                    fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, or_);
                                    fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[0].data).node_id);
...
#line 739 "translate.y"
                                { 
                                    ...
                                    fprintf(dot, "{rank=same; n%d n%d n%d;}\n", (yyvsp[-2].data).node_id, not_, (yyvsp[0].data).node_id);

                                    fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[-2].data).node_id);
                                    fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, not_);
                                    fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[0].data).node_id);
...
#line 755 "translate.y"
                                { 
                                    ...
                                    fprintf(dot, "{rank=same; n%d n%d n%d;}\n", (yyvsp[-2].data).node_id, xor_, (yyvsp[0].data).node_id);
...
#line 770 "translate.y"
                                { 
                                    ...
                                    fprintf(dot, "{rank=same; n%d n%d n%d;}\n", (yyvsp[-2].data).node_id, lshift, (yyvsp[0].data).node_id);

                                    fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[-2].data).node_id);
                                    fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, lshift);
                                    fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[0].data).node_id);
...
#line 786 "translate.y"
                                { 
                                    ...
                                    fprintf(dot, "{rank=same; n%d n%d n%d;}\n", (yyvsp[-2].data).node_id, rshift, (yyvsp[0].data).node_id);

                                    fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[-2].data).node_id);
                                    fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, rshift);
                                    fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[0].data).node_id);
...
#line 802 "translate.y"
                    { 
                        ...
                        fprintf(dot, "{rank=same; n%d n%d n%d;}\n", (yyvsp[-2].data).node_id, eq, (yyvsp[0].data).node_id);

                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[-2].data).node_id);
                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, eq);
                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[0].data).node_id);
...
#line 818 "translate.y"
                    { 
                        ...
                        fprintf(dot, "{rank=same; n%d n%d n%d;}\n", (yyvsp[-2].data).node_id, ne, (yyvsp[0].data).node_id);
                        
                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[-2].data).node_id);
                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, ne);
                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[0].data).node_id);
...
#line 834 "translate.y"
                    { 
                        ...
                        fprintf(dot, "{rank=same; n%d n%d n%d;}\n", (yyvsp[-2].data).node_id, lt, (yyvsp[0].data).node_id);

                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[-2].data).node_id);
                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, lt);
                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[0].data).node_id);
...
#line 851 "translate.y"
                    { 
                        ...
                        fprintf(dot, "{rank=same; n%d n%d n%d;}\n", (yyvsp[-2].data).node_id, gt, (yyvsp[0].data).node_id);

                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[-2].data).node_id);
                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, gt);
                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[0].data).node_id);
...
#line 867 "translate.y"
                    { 
                        ...
                        fprintf(dot, "{rank=same; n%d n%d n%d;}\n", (yyvsp[-2].data).node_id, le, (yyvsp[0].data).node_id);

                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[-2].data).node_id);
                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, le);
                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[0].data).node_id);
...
#line 883 "translate.y"
                    { 
                        ...
                        fprintf(dot, "{rank=same; n%d n%d n%d;}\n", (yyvsp[-2].data).node_id, ge, (yyvsp[0].data).node_id);
                        
                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[-2].data).node_id);
                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, ge);
                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[0].data).node_id);
...
#line 930 "translate.y"
                                    { 
                                        ...
                                        fprintf(dot, "{rank=same; n%d n%d n%d;}\n", paren, (yyvsp[-1].data).node_id, close_paren);

                                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, paren);
                                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[-1].data).node_id);
                                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, close_paren);
                                    }
...
#line 948 "translate.y"
                                    { 
                                        ...
                                        fprintf(dot, "{rank=same; n%d n%d;}\n", not, (yyvsp[0].data).node_id);
                        
                                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, not);
                                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[0].data).node_id);
...
#line 987 "translate.y"
                                    { 
                                        ...
                                        fprintf(dot, "{rank=same; n%d n%d n%d;}\n", (yyvsp[-2].data).node_id, assign_, (yyvsp[0].data).node_id);
...
#line 1046 "translate.y"
                                { 
                                    ...
                                    fprintf(dot, "n%d [label=\"attr\"]\n", (yyval.data).node_id);
                                    fprintf(dot, "n%d [label=\"%s\"]\n", id, (yyvsp[-1].data).data.string);

                                    fprintf(dot, "{rank=same; n%d n%d;}\n", id, (yyvsp[0].data).node_id);
...
#line 1141 "translate.y"
                                    { 
                                        ...
                                        fprintf(dot, "{ rank=same; n%d n%d n%d;}\n", open_bracket, (yyval.data).node_id, close_bracket);
                                        
                                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, open_bracket);
                                        fprintf(dot, "n%d -- n%d\n", (yyval.data).node_id, (yyvsp[-1].data).node_id);
